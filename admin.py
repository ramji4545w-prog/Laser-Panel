...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .info-item .val { color: #ccc; margin-top: 1px; }
  ...
  .tabs { display: flex; gap: 0; padding: 0 30px; border-bottom: 1px solid #1a1a1a; margin-top: 10px; }
  .tab {
    padding: 10px 20px;
    font-size: 0.82rem;
...
<header>
  <h1>🔥 Admin Panel</h1>
  <span>Payment Requests Dashboard</span>
</header>
...
def home():
    ...
    return render_template_string(HTML, users=users, stats=stats, filter=f)
